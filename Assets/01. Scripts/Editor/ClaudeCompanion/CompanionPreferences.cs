// Cross-cutting Companion settings read from outside ClaudeCompanionWindow (namely
// CompanionSession, which builds the text actually sent to the CLI) without threading a
// window reference through every session instance. ClaudeCompanionWindow's own Language
